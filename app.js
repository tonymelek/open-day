...
const grpAct = {
    smallKids: [
        ...
        lunch,
        { from: '14:30:00', to: '16:00:00', name: 'Entertainment', list: ['Jumping Castle', 'Face Painting', 'Craft Art'] },
        closing
    ],
    midKids: [
        ...commonActivities1,
        ...
        lunch,
        { from: '14:30:00', to: '16:00:00', name: 'Entertainment', list: ['Jumping Castle', 'Soccer', 'Face Painting'] },
        closing
    ], highschool: [
        ...commonActivities1,
        { from: '12:00:00', to: '14:00:00', name: 'Entertainment', list: ['Soccer', 'Tennis Table', 'Basket Ball'] },
        lunch,
        { from: '14:30:00', to: '16:00:00', name: 'Entertainment', list: ['Soccer', 'Tennis Table', 'Basket Ball'] },
        closing
    ]
}
...
const app = {
    ...
    methods: {
        getClass(index){
            console.log(index,this.activePeriodIndex);
